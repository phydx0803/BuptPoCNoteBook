...
\usepackage{pifont}
\newcommand{\thmref}[1]{{\texttt{\color{\linkcolor}定理}{\thinspace\ref{#1}}}}
\newcommand{\defref}[1]{{\texttt{\color{\linkcolor}定义}{\thinspace\ref{#1}}}}
\newcommand{\eqaref}[1]{{\color{\linkcolor}\texttt{式}{(\thinspace\ref{#1})}}}
\newcommand{\figref}[1]{{\texttt{\color{\linkcolor}图}{\thinspace\ref{#1}}}}
\newcommand{\tabref}[1]{{\texttt{\color{\linkcolor}表}{\thinspace\ref{#1}}}}
...
\CTEXsetup[format={\rmfamily\bfseries\songti\zihao{-4}\color{\linkcolor}}]{paragraph}
\CTEXsetup[name={,.}]{paragraph}
\CTEXsetup[beforeskip={0em}]{paragraph}
\CTEXsetup[afterskip={0em}]{paragraph}
\CTEXsetup[aftername={\hspace{0.2em}}]{paragraph}
\CTEXsetup[indent=2em]{paragraph}
%subparagrapha
\renewcommand{\thesubparagraph}{\arabic{subparagraph}}
\CTEXsetup[format={\rmfamily\mdseries\songti\zihao{-4}}]{subparagraph}
\CTEXsetup[name={（,）\hspace{-1em}}]{subparagraph}
\CTEXsetup[beforeskip={-1ex}]{subparagraph}
\CTEXsetup[afterskip={-1ex}]{subparagraph}
\CTEXsetup[aftername={\hspace{0em}}]{subparagraph}
\CTEXsetup[indent=2em]{subparagraph}
